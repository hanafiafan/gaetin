      ...
      <div className="cg-card overflow-hidden rounded-2xl">
        <div className="grid gap-5 p-6 lg:grid-cols-[minmax(0,1fr)_360px]">
          ...
          <div className="grid gap-2 text-sm">
            <div className="flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3 py-2 text-slate-300"><MessageSquare className="h-4 w-4 text-primary" /> Percakapan dua arah</div>
            <div className="flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3 py-2 text-slate-300"><UserCheck className="h-4 w-4 text-primary" /> Status open, pending, resolved</div>
            <div className="flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3 py-2 text-slate-300"><Headphones className="h-4 w-4 text-primary" /> Cocok untuk sales dan customer support</div>
          </div>
        </div>
      </div>
      <InboxClient />
