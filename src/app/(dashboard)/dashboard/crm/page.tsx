      ...
      <div className="cg-card overflow-hidden rounded-2xl">
        <div className="grid gap-5 p-6 lg:grid-cols-[minmax(0,1fr)_360px]">
          ...
          <div className="grid gap-2 text-sm">
            <div className="flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3 py-2 text-slate-300"><KanbanSquare className="h-4 w-4 text-primary" /> Kanban pipeline untuk follow-up harian</div>
            <div className="flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3 py-2 text-slate-300"><BadgeDollarSign className="h-4 w-4 text-primary" /> Closed Won otomatis masuk revenue</div>
            <div className="flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3 py-2 text-slate-300"><Workflow className="h-4 w-4 text-primary" /> Hubungkan aktivitas sales dan campaign</div>
          </div>
        </div>
      </div>
      <CrmBoard />
