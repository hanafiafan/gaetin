      ...
      <div className="cg-card overflow-hidden rounded-2xl">
        <div className="grid gap-5 p-6 lg:grid-cols-[minmax(0,1fr)_360px]">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-foreground">Follow-up Otomatis</h1>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
              Buat aturan tindak lanjut untuk kontak yang belum membalas. Rangkaian berhenti saat kontak membalas.
            </p>
          </div>
          <div className="grid gap-2 text-sm">
            <div className="flex items-center gap-2 rounded-xl border border-border bg-card px-3 py-2 text-foreground/80"><Repeat className="h-4 w-4 text-primary" /> No-reply follow-up</div>
            <div className="flex items-center gap-2 rounded-xl border border-border bg-card px-3 py-2 text-foreground/80"><Bot className="h-4 w-4 text-primary" /> Otomasi berbasis aturan</div>
            <div className="flex items-center gap-2 rounded-xl border border-border bg-card px-3 py-2 text-foreground/80"><Clock className="h-4 w-4 text-primary" /> Cron-ready untuk produksi</div>
          </div>
        </div>
      </div>
      <FollowUpsClient />
