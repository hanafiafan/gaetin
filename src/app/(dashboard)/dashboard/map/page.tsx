...
export default async function MapHistoryPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-76px)] flex-col gap-4 p-4 md:gap-6 md:p-6 lg:p-8">
      <div>
        <Badge className="mb-3 inline-flex items-center gap-1.5 border border-primary/25 bg-primary/15 px-3 py-1 text-xs font-bold text-foreground hover:bg-primary/15">
