      ...
      <div className="cg-card rounded-2xl p-4">
        <form onSubmit={create} className="grid gap-3 lg:grid-cols-[1fr_220px_160px_140px_auto]">
          ...
          <button
            type="submit"
            disabled={!title.trim()}
            className="flex h-10 items-center gap-1.5 rounded-lg bg-primary px-4 text-sm font-bold text-primary-foreground transition hover:bg-primary/90 disabled:opacity-50"
          >
