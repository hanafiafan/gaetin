  ...
  return (
    <header className="sticky top-0 z-30 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex min-h-[72px] max-w-[1440px] items-center justify-between gap-4 px-3 sm:px-5 lg:px-7">
        ...
        <div className="hidden min-w-[280px] max-w-md flex-1 items-center rounded-full border bg-muted/50 px-4 py-2 text-sm text-muted-foreground xl:flex">
        ...
        <div className="flex items-center gap-2">
          {isSuperAdmin ? (
            <Link
              href="/admin"
              className="hidden h-10 items-center gap-2 rounded-full border bg-background px-4 text-sm font-semibold transition hover:bg-muted md:inline-flex"
            >
          ...
          <button
            type="button"
            className="relative flex h-10 w-10 items-center justify-center rounded-full border bg-background transition hover:bg-muted"
          >
            <Bell className="h-4 w-4 text-foreground" />
            <span className="absolute right-2.5 top-2.5 h-2 w-2 rounded-full bg-primary ring-2 ring-background" />
          </button>

          <div className="flex items-center gap-3 rounded-full border bg-background py-1 pl-1 pr-3 transition hover:bg-muted cursor-pointer">
