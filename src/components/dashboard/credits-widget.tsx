...
export default function CreditsWidget({ credits, plan, subscriptionStatus, variant = "full" }: CreditsWidgetProps) {
  ...
  if (variant === "compact") {
    return (
      <div className="cg-card cg-sheet mx-3 mt-3 rounded-xl p-3">
  ...
  return (
    <div className={cn("cg-card cg-sheet mt-5 rounded-xl p-3", isLowCredits && "border-warning")}>
      ...
      <Link
        ...
        className="cg-label cg-press mt-3 flex h-10 w-full items-center justify-center rounded-lg hover:bg-primary hover:text-primary-foreground"
      >
